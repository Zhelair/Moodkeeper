(function(){
  ...
  TrackboardRouter.register('checkin', async (mount)=>{
    ...
    const moodCard = UI.h('div',{class:'card'},[
      UI.h('div',{class:'h2'},['How does this day feel right now?']),
    ...
    const tagCard = UI.h('div',{class:'card'},[
      UI.h('div',{class:'h2'},['What influenced this day?']),
    ...
    const posCard = UI.h('div',{class:'card soft'},[
      UI.h('div',{class:'h2'},['One positive moment']),
    ...
    const actions = UI.h('div',{class:'card soft'},[
      UI.h('button',{class:'btn primary full', type:'button', id:'btn-save'},['Save'])
    ]);
