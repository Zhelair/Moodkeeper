(function(){
  ...
  function renderAlcohol(){
    ...
    async function renderWeek(){
      const base = new Date((TrackboardUI.activeISO ? TrackboardUI.activeISO() : TrackboardUI.todayISO()) + 'T00:00:00');
  ...
  TrackboardRouter.register("alcohol", async () => {
    ...
    TrackboardUI.setSubtitle(`Alcohol · ${TrackboardUI.fmtActive ? TrackboardUI.fmtActive() : TrackboardUI.activeISO()} · Private · Stored on this device`);
  });
})();
